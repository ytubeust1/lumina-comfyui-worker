...
# Added: ReActor (face swap), IP-Adapter (face consistency), AnimateDiff (video)
...
# Download ReActor face swap model
...
# Download IP-Adapter face model for face consistency
...
# Download AnimateDiff motion model for video
